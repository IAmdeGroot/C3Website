...
renderText = () => {
    ...
    {(matches)  => {
          ...
          return(
            <p style={STYLE}> 
            Jag har blivit kallad avväpnande. Själv ser jag mig som en driven, organiserad och engagerad person som brinner för utveckling och IT. 
            Utöver studiernas traditionella fokus på programspråk som JAVA och SQL besitter jag ett stort intresse för apputveckling då jag på fritiden spenderar tid med React Native (Javascript, CSS, React) för att skapa applikationer. <br/> <br/>
